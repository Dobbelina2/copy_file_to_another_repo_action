...
* source_file: The file(s) or directory(s) to be moved. Uses the same syntax as the `rsync` command. Include the path for any files not in the repositories root directory. Multiple source files separated by space `"file1.txt file2.txt"`
